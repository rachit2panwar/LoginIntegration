...
public class LinkedIn extends AppCompatActivity {
            ...
            LISessionManager.getInstance(getApplicationContext()).init(this, buildScope()//pass the build scope here
                    , new AuthListener() {
                        ...
                        public void onAuthSuccess() {
                            ...
                            Toast.makeText(LinkedIn.this, "Successfully authenticated with LinkedIn.", Toast.LENGTH_SHORT).show();
                        ...
                        public void onAuthError(LIAuthError error) {
                            ...
                            Toast.makeText(LinkedIn.this, "Failed to authenticate with LinkedIn. Please try again.", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void fetchBasicProfileData() {
        ...
        apiHelper.getRequest(this, url, new ApiListener() {
            ...
            public void onApiSuccess(ApiResponse apiResponse) {
                ...
                Toast.makeText(LinkedIn.this, "Successfully fetched LinkedIn profile data.", Toast.LENGTH_SHORT).show();
            ...
            public void onApiError(LIApiError liApiError) {
                ...
                Toast.makeText(LinkedIn.this, "Failed to fetch basic profile data. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onShareClick(View view) {
        ...
        apiHelper.postRequest(this, url, body, new ApiListener() {
            ...
            public void onApiSuccess(ApiResponse apiResponse) {
                ...
                Toast.makeText(LinkedIn.this, "Shared successfully.", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onApiError(LIApiError liApiError) {
                ...
                Toast.makeText(LinkedIn.this, "Failed to share. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void openMyProfile(View view) {
        ...
        deepLinkHelper.openCurrentProfile(this, new DeepLinkListener() {
            ...
            public void onDeepLinkSuccess() {
                ...
                Toast.makeText(LinkedIn.this, "Current profile opened successfully.", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onDeepLinkError(LIDeepLinkError error) {
                ...
                Toast.makeText(LinkedIn.this, "Failed to open current profile.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void openOthersProfile(View view) {
        ...
        deepLinkHelper.openOtherProfile(this, targetID, new DeepLinkListener() {
            ...
            public void onDeepLinkSuccess() {
                // Successfully sent user to LinkedIn app
                Toast.makeText(LinkedIn.this, "Other profile opened successfully.", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onDeepLinkError(LIDeepLinkError error) {
                ...
                Toast.makeText(LinkedIn.this, "Failed to open other profile.", Toast.LENGTH_SHORT).show();
            }
        });
    }
